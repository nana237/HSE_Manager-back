...
app.get('/first-aid/:id/get', async (req, res) => {
  const { id } = req.params;
...
app.post('/first-aid/:id/item/create', async (req, res) => {
  const { id } = req.params;
...
app.post('/first-aid/:kitId/:itemId/update', async (req, res) => {
...
app.post('/first-aid/:kitId/:itemId/delete', async (req, res) => {
  const { kitId, itemId } = req.params;
  const item = await FirstAidKitItem.findOne({ where: { id: itemId, kitId } });
  if (item) {
    await item.destroy();
